...
simChoice = input('1 for new input file, 2 for PNJctEqBias: ');
if(simChoice==1)
    Simulation = 'newInputFile';
elseif(simChoice==2)
    Simulation = 'PNJctEqBias';
end
...
elseif strcmp(Simulation,'newInputFile')
    eval('newInputFile');
end
...
TwoCarriers = input('Set TwoCarriers flag: ');
...
Coupled = input('Set Coupled flag: ');
